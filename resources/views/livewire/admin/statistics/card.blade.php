<div class="row mt-2" wire:poll.keep-alive>
                ...
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">
                            Lợi nhuận trong tháng</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{$profitMonth}} (VND)</div>
                    </div>
                    <div class="col-auto">
                        <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                    </div>
        ...
        <div class="card border-left-danger shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">
                            Lợi nhuận trong năm</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{$profitYear}} (VND)</div>
                    </div>
                    <div class="col-auto">
                        <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                    </div>
